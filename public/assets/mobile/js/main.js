    ...
    (function ($) {
        $.dragScroll = function (options) {
            ...
            var getCursor = function () {
                ...
                if (settings.scrollVertical && settings.scrollHorizontal) return 'url(/assets/mobile/img/touch.png), move';
            ...
            $(document).on({
                ...
                'mouseup': function () {
                    clicked = false;
                    $('html').css('cursor', 'url(/assets/mobile/img/logo-cursor.png), auto');
                }
            });
        }
    }(jQuery))
