...
class AdsController extends Controller
{
    ...
    public function index()
    {
        ...
        $allads = MarketerControllerAds::where('controller_id', $user_id)->orderBy('id', 'desc')->get();
        return view('marketing_panel.ads.index', compact('allads'));
    }
...
//        return $request->all();
        ...
        $ads->starting = Carbon::parse($request->input('startingDate'))->format('Y-m-d H:i:s');
        $ads->ending = Carbon::parse($request->input('endingDate'))->format('Y-m-d H:i:s');
