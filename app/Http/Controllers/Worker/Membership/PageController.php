...
class PageController extends Controller
{
    ...
    public function index()
    {
        if (auth()->user()->membership()->count() > 0){
            if (auth()->user()->membershipPages->count() > 0){
                return redirect()->route('worker.page.edit', auth()->user()->membershipPages->first()->id);
            }else{
                return redirect()->route('worker.page.create');
            }
        }else{
    ...
    public function create()
    {
        ...
        if (auth()->user()->membership()->count() > 0){
            ...
            if (auth()->user()->membershipPages->count() > 0){
                ...
                return view('worker.membership.page.create',compact('categories'));
            }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return response()->json([
                'type' => 'success',
                'message' => 'Success',
                'url' => route('worker.page.edit', $membership_page->id) ,
            ]);
    ...
    public function edit($id)
    {
        ...
        return view('worker.page.edit', compact('myPage'));
       ///echo $memberPage;
    }
