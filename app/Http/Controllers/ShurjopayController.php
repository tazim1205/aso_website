...
namespace App\Http\ShurjopayController;
...
class ShurjopayController extends Controller
{
    public function getPaymentView(){
        ...
        $success_route = url('https://datatechbd.com/'); // optional.

        $shurjopay_service->sendPayment(100, $success_route); // You can call simply $shurjopay_service->sendPayment(2) without success route
    }
