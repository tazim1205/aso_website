        ...
        <div class="row mx-0">
            <div class="container">
                <div class="text-center">
                    <h3 class="btn btn-default btn-lg btn-rounded shadow my-2"><b>{{ __('Terms and conditions') }}</b></h3>
                </div>
                        ...
                        <div class="row">
                            <div>
                                @if(current_language() != 'en')
                                    {!! $terms_and_condition->en_description !!}
                                @else
                                    {!! $terms_and_condition->bn_description !!}
                                @endif
                            </div>
                        </div>
                    </div>
