    ...
    <div class="row">
        <div class="col">
            <div class="list-group main-menu">
                <a href="{{ route('marketer.home.index') }}" class="list-group-item list-group-item-action @if(Route::is('marketer.home.index')) active @endif"><i class="material-icons icons-raised">home</i>{{ __('Home') }}</a>
                 

                <a href="{{ route('marketer.profile.index') }}" class="list-group-item list-group-item-action @if(Route::is('marketer.profile.index')) active @endif"><i class="material-icons icons-raised">face</i>{{ __('More') }}</a>
