                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form id="add-new-from">
                                                    ...
                                                    <input type="hidden" name="worker_or_customer" id="worker_or_customer" value="worker">
                                ...
                                <div class="card-body">
                                    <form class="form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control email" value="{{ $notice->email }}">
                                        </div>
                                        <div class="form-group">
                                            <label for="phone">Phone:</label>
                                            <input type="phone" class="form-control phone" value="{{ $notice->phone }}" >
                                        </div>
...
<script>
    $(document).ready(function() {
            ...
            $('.update-submit-button').click(function(){
                ...
                formData.append('worker_or_customer', "worker");
                $.ajax({
                    method: 'POST',
