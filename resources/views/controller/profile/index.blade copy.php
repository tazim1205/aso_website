        ...
        <div class="container-fluid">
            ...
            <div class="row pt-2 pb-2">
                <div class="col-sm-9">
                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javaScript:void();">{{ __('Profile') }}</a></li>
                        <li class="breadcrumb-item"><a href="javaScript:void();">{{ __('Pages') }}</a></li>
                        <li class="breadcrumb-item active" aria-current="page">{{ auth()->user()->full_name }}</li>
                    </ol>
                </div>
            </div>
            <!-- End Breadcrumb-->
