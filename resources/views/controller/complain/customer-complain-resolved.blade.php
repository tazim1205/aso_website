...
@push('title')
{{ __('Resolved Customer complain List') }}
@endpush
@push('head')
                            ...
                            <div class="card card-background-blue">
                                <div class="card-content">
                                    <div class="card-body select-card-design">
                                        ...
                                        <h4 class="select-title width_100_percent white">Report Management - Resolved
                                        </h4>
                            ...
                            <div class="modal-body">
                                <form action="#" method="POST">
                                    <div class="form-group">
                                        ...
                                        <img src="../assets//images/order/1.jpg" width="200" alt="" id="blah">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="order_number" class="form-control" value="344554"
                                            id="order_number">
                                    </div>
                                    <div class="form-group">
                                        <label for="customer_username" class="col-form-label">Customer Username</label>
                                        <input type="text" name="customer_username" class="form-control"
                                            value="chomokhasan40" id="customer_username">
                                    </div>
                                    <div class="form-group">
                                        <label for="worker_username" class="col-form-label">Worker Username</label>
                                        <input type="text" name="worker_username" class="form-control" value="smith455"
                                            id="worker_username">
                                    </div>
                                    <div class="form-group">
                                        <label for="careate_date" class="col-form-label">Order Create Date</label>
                                        <input type="date" name="careate_date" class="form-control" id="careate_date">
                                    </div>
                                ...
                                <form action="#" method="POST">
                                    ...
                                    <div class="form-group">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" name="" id="comment" rows="7">
