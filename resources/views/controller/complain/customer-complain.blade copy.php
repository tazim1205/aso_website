            ...
            <div class="row pt-2 pb-2">
                <div class="col-sm-9">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javaScript:void();">{{ __('Customer') }}</a></li>
                        <li class="breadcrumb-item active" aria-current="page">{{ __('Customer complain List') }}</li>
                    </ol>
                </div>
            </div>
            <!-- End Breadcrumb-->
                                    ...
                                    @foreach($customers as $customer)
                                        @foreach($customer->complains as $complain)
                                            <tr>
                                                ...
                                                <td scope="col">
                                                    <button type="button" id="{{ $complain->id }}" data-complain="{!! $complain->complain !!}" class="view-button btn btn-outline-warning waves-effect waves-light m-1 view-complain"> <i class="fa fa-eye"></i> </button>
