            ...
            <div class="card card-background-blue">
                <div class="card-content">
                    <div class="card-body select-card-design">
                        ...
                        <select name="category" id="category" class="form-control width-25-percent">
                            <option value=''>--Salary Category--</option>
                            <option value='director' @if(request()->get('category') == 'director') selected @endif>Director</option>
                            <option value='manager' @if(request()->get('category') == 'manager') selected @endif>Manager</option>
                            <option value='marketing_manager' @if(request()->get('category') == 'marketing_manager') selected @endif>Marketing Manager</option>
                            <option value='accountant' @if(request()->get('category') == 'accountant') selected @endif>Accountant</option>
                            <option value='marketing_panel_controller' @if(request()->get('category') == 'marketing_panel_controller') selected @endif>Marketing Panel Controller</option>
        ...
        $(document).ready( function () {
            function filter(){
                var dataTable = $('#datatable').DataTable({
                    ...
                    // scrollX: true,
                    "order": [[ 0, "desc" ]],
                    ajax: "{{  route('accountant.expenses.salary.salary-report') }}",
                    columns: [
                        ...
                        {data: 'note', name: 'note',orderable:false,serachable:false,},
                    ]
                });
            }
            filter();
