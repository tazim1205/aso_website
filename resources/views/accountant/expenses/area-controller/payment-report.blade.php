                        ...
                        <div class="table-responsive">
                            <table id="users-contacts" class="table table-white-space table-bordered table-striped row-grouping display no-wrap icheck table-middle">
                                ...
                                <tr>
                                    ...
                                    <th>Paid month</th>
                                    <th>Upazila</th>
                                    <th>Area's Net Profit</th>
                                    <th>Paid Via</th>
                                    <th>Controller A/C num.</th>
                                    <th>controller A/C  details</th>
                                    <th>Company A/C num.</th>
                                    <th>Company A/C details</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {{ $report->controller_ac_number }}
                                        </td>
                                        <td>
                                            {{ $report->controller_ac_details }}
                                        </td>
                                        <td>
                                            {{ $report->company_ac_number }}
                                        </td>
                                        <td>
                                            {{ $report->company_ac_details }}
                                        </td>
                                        <td>
