...
@section('title', 'Affiliate Marketer Expense')
                    ...
                    <div class="card-body">
                        <div class="media d-flex">
                            <div class="media-body text-left align-self-bottom">
                                ...
                                <h5 class="mb-0 font-weight-bolder" id="total_marketer">{{ $total }}</h5>
                            </div>
            ...
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        <div class="media d-flex">
                            <div class="media-body text-left align-self-bottom">
                                <span class="d-block mb-1 font-medium-1">Total Aff. Marketer Exp.</span>
                                <h5 class="mb-0 font-weight-bolder" id="marketer_exp">{{ $totalExpense }}</h5>
                            </div>
                            <div class="align-self-top">
                                <i class="material-icons dark-blue font-large-3">account_balance_wallet
                                </i>
            ...
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        <div class="media d-flex">
                            <div class="media-body text-left align-self-bottom">
                                <span class="d-block mb-1 font-medium-1">Tatal Paid</span>
                                <h5 class="mb-0 font-weight-bolder" id="marketer_paid">{{ $totalPaid }}</h5>
                            </div>
                            <div class="align-self-top">
                                <i class="material-icons dark-blue font-large-3">account_balance_wallet
                                </i>
                    ...
                    <div class="card-body">
                        <div class="media d-flex">
                            <div class="media-body text-left align-self-bottom">
                                ...
                                <h5 class="mb-0 font-weight-bolder" id="marketer_pending">{{ $totalPending }}</h5>
                            </div>
                            <div class="align-self-top">
                                <i class="material-icons dark-blue font-large-3">account_balance_wallet
                                </i>
