...
@section('title', 'Company Global Ad Expense.')
...
@section('content')
    ...
    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#new_create">
        <i class="fa fa-plus"></i> Create New Company Add Exp.
    </button> <h3></h3>
    <!--Model Start-->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('accountant.expenses.ad.ad-global.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary">Create New Company Ad Exp.</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        $(document).ready( function () {
            function filter(district, upazila, month, year){
                var dataTable = $('#datatable').DataTable({
                    ...
                    // scrollX: true,
                    "order": [[ 0, "desc" ]],
                    ajax: "{{  url('/accountant/expenses/ad/ad-global-report/') }}/"+district+"/"+upazila+"/"+month+"/"+year,
                    columns: [
