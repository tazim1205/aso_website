        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('accountant.earnings.others.report.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" id="" cols="15" rows="10" class="form-control" placeholder="Enter details" id="details"></textarea>
                        </div>
        ...
        $(document).ready( function () {
            function filter(){
                var dataTable = $('#datatable').DataTable({
                    ...
                    // scrollX: true,
                    "order": [[ 0, "desc" ]],
                    ajax: "{{  route('accountant.earnings.others.report') }}",
                    columns: [
