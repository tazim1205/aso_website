...
@section('content')
    ...
    <h3 class="btn btn-primary">Package Quantity</h3>
    <div class="row">
        <!--Card 1-->
                    ...
                    <div class="card-body">
                        <div class="media d-flex">
                            <div class="media-body text-left align-self-bottom">
                                <span class="d-block mb-1 font-medium-1">Total Package Buy 1st Time</span>
                                <h5 class="mb-0 font-weight-bolder" id="quantity_first_time">{{ $quantity['first_time'] }}</h5>
                            </div>
            ...
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        <div class="media d-flex">
                            <div class="media-body text-left align-self-bottom">
                                <span class="d-block mb-1 font-medium-1">Total package Upgrade</span>
                                <h5 class="mb-0 font-weight-bolder" id="quantity_upgrade">{{ $quantity['upgrade'] }}</h5>
                            </div>
                            <div class="align-self-top">
                                <i class="material-icons dark-blue font-large-3">account_balance_wallet
                                </i>
            ...
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        <div class="media d-flex">
                            <div class="media-body text-left align-self-bottom">
                                <span class="d-block mb-1 font-medium-1">Total package Renew</span>
                                <h5 class="mb-0 font-weight-bolder" id="quantity_renew">{{ $quantity['renew'] }}</h5>
                            </div>
                            <div class="align-self-top">
                                <i class="material-icons dark-blue font-large-3">account_balance_wallet
                                </i>
    ...
    <h3 class="btn btn-primary">Package Price Amount</h3>
    <div class="row">
        <!--Card 1-->
        <div class="col-12 col-sm-6 col-lg-6 col-xl-3 col-md-3">
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        <div class="media d-flex">
                            <div class="media-body text-left align-self-bottom">
                                <span class="d-block mb-1 font-medium-1">Total Package Buy 1st Time</span>
                                <h5 class="mb-0 font-weight-bolder" id="price_first_time">{{ $total['first_time'] }}</h5>
                            </div>
                            <div class="align-self-top">
                                <i class="material-icons dark-blue font-large-3">account_balance_wallet
                                </i>
                ...
                <div class="card-content">
                    <div class="card-body">
                        <div class="media d-flex">
                            <div class="media-body text-left align-self-bottom">
                                <span class="d-block mb-1 font-medium-1">Total package Upgrade</span>
                                <h5 class="mb-0 font-weight-bolder" id="price_upgrade">{{ $total['upgrade'] }}</h5>
                            </div>
                            <div class="align-self-top">
                                <i class="material-icons dark-blue font-large-3">account_balance_wallet
                                </i>
                ...
                <div class="card-content">
                    <div class="card-body">
                        <div class="media d-flex">
                            <div class="media-body text-left align-self-bottom">
                                <span class="d-block mb-1 font-medium-1">Total package Renew</span>
                                <h5 class="mb-0 font-weight-bolder" id="price_renew">{{ $total['renew'] }}</h5>
                            </div>
                            <div class="align-self-top">
                                <i class="material-icons dark-blue font-large-3">account_balance_wallet
                                </i>
