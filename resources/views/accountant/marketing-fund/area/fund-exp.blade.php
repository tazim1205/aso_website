...
@section('content')
    ...
    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#new_create">
        <i class="fa fa-plus"></i> Create New Area's Fund Exp.
    </button> <h3></h3>
    <!--Model Start-->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('accountant.marketing-fund.area.fund-exp-store')}}" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <select name="upazila" class="form-control" required>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary">Create New Area Fund Exp.</button>
                        </div>
                    </form>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="users-contacts" class="table table-white-space table-bordered table-striped row-grouping display no-wrap icheck table-middle">
                                ...
                                <tbody>
                                    @foreach ($areaFundExpenses as $item)
                                        <tr>
