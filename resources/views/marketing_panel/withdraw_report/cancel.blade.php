...
@push('title') {{ __('Cancel Withdraw Report') }} @endpush
@push('head')
            ...
            <div class="card">
                <div class="card-head">
                    <div class="card-header">
                        <h4 class="card-title">Withdraw Cancel</h4>
        ...
        $(document).ready( function () {
            function filter(district, upazila, month, year){
                var dataTable = $('#datatable').DataTable({
                    ...
                    // scrollX: true,
                    "order": [[ 0, "desc" ]],
                    ajax: "{{  url('/filter/marketer/withdrawrequest/cancel/') }}/"+district+"/"+upazila+"/"+month+"/"+year,
                    columns: [
                        {data: 'id', name: 'id'},
                        {data: 'date', name: 'date'},
