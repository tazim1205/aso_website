                                            ...
                                            <tbody>
                                                @foreach ($service_provider as $worker)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="hidden" class="hidden-url" value="{{ $worker->link }}">
                                                            <input type="hidden" class="hidden-id" value="{{ $worker->id }}">
                                                            <input type="hidden" class="hidden-title" value="{{ $worker->title }}">
                                                            <input type="hidden" class="hidden-video_for" value="{{ $worker->video_for }}">
                                                            <a
                                                                href="javascript:void();"
                                                                class="card-link edit-button"
                                                                data-toggle="modal"
