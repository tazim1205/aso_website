    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <div class="row pt-2 pb-2">
                <div class="col-sm-9">
                    <h4 class="page-title">{{ __('Worker service categories') }} </h4>
                </div>
                <div class="col-sm-3">
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="{{ asset('uploads/images/worker/service-category/'.$category->icon) }}" height="50px" width="50px" style="border-radius: 15px;"></td>
                                        <td>{{ $category->name }}</td>
                                        <td>
    ...
    <script>
        $(document).ready(function() {
           ...
           $('#add-submit-button').click(function(){
               ...
               $.ajax({
                   method: 'POST',
                   url: '/admin/worker-service-category',
            ...
            $(".edit-button").click(function(){
                ...
                $('#meta_tag').val($(this).parent().parent().find('.hidden_meta_tag').val());
            });
            ...
            $('#edit-submit-button').click(function(){
                ...
                $.ajax({
                    method: 'POST',
                    url: '/admin/worker-service-category/update',
                    headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                    data: formData,
                    processData: false,
                    contentType: false,
