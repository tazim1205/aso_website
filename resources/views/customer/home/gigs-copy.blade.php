    ...
    <div class="container">
        ...
        <div class="row" id="page_area">
            <div class="col-12 mb-2 pb-3" style="border-bottom: 1px solid #e6e6e6;">
                ...
                <div class="row">
                    <div class="col-lg-3 now_online_area">
                        <a href="" id="page_now_online" title="Click To Active" class="btn btn-sm btn-default page_now_online_deactive"><i class="fa fa-toggle-off text-white page_now_online_icon" id="page_now_online_icon"></i></a> {{ __('এখন অনলাইন') }}
                    </div>
                    <div class="col-lg-3 recent_online_area">
                        <a href="" id="page_recent_online" title="Click To Active" class="btn btn-sm btn-default page_recent_online_deactive"> <i class="fa fa-toggle-off text-white page_recent_online_icon" id="page_recent_online_icon"></i></a> {{ __('সাম্প্রতিক অনলাইন') }}
                    </div>
                    <div class="col-lg-3 recent_order_delivery_area">
                        <a href="" id="page_recent_order_delivery" title="Click To Active" class="btn btn-sm btn-default page_recent_order_delivery_deactive"> <i class="fa fa-toggle-off text-white page_recent_order_delivery_icon" id="page_recent_order_delivery_icon"></i></a> {{ __('সাম্প্রতিক অর্ডার ডেলিভারি') }}
                    </div>
                </div>
            </div>
            <div class="col-12 px-0">
