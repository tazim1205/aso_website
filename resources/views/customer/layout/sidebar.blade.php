    ...
    <div class="bar-area">
        <div class="bar-cont">
            ...
            <div class="bar-menu-area">
                <a href="{{ route('customer.home.index') }}" class="@if(Route::is('customer.home.index')) active @endif">
                    <div class="bar-menu">
                ...
                <a href="{{ route('customer.myJob') }}" class="@if(Route::is('customer.myJob')) active @endif">
                    <div class="bar-menu">
                        <div class="bar-menu-img">
                ...
                <a href="{{ route('customer.profile.index') }}" class="@if(Route::is('customer.profile.index')) active @endif">
                    <div class="bar-menu">
                        <div class="bar-menu-img">
