        ...
        <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer border-0">
                    <button type="button" class="btn btn-default btn-lg btn-rounded shadow btn-block close" aria-hidden="true" data-dismiss="modal">Close</button>
                </div>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="complete-modal-test" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" aria-labelledby="staticBackdropLabel">
    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header border-0">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
    ...
    <div class="modal-dialog modal-md modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer border-0" id="review_btn">
                <input type="hidden" name="bid" id="bid_id">
                <input type="hidden" name="update" id="update_rating" value="0">
                @if (isset($review))
                    <button type="button" id="update_review_submit" class="btn btn-success btn-lg btn-rounded shadow btn-block">SUBMIT</button>
                @else 
...
<div class="modal fade" id="customerSearchForm" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" aria-labelledby="staticBackdropLabel">
            ...
            <div class="modal-body pt-0">
                {{-- <div class="row mx-0">
                    <div class="col-12 container text-center small">
                        <p>{{ __('এখানে সার্চ করুন।') }}</p>
                    </div>
                </div> --}}
                <form class="text-center" method="Post" action="{{ route('customer.search') }}">
                    @csrf
                    <div class="col-12">
                        <input type="text" name="search_text" class="form-control" placeholder="{{ __('গিগ, পেইজ ও সার্ভিস সার্চ করুন...') }}" required="">
                    </div>
...
<div class="modal hide fade" id="customerAreChangeModal" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" aria-labelledby="staticBackdropLabel">
    <div class="modal-dialog  modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header border-0">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
