    ...
    <div class="container">
        <div class="row no-gutters login-row">
            <div class="col align-self-center px-3 text-center">
                ...
                <h4 class="mt-3">{{ __('Customer Profile Update') }}</h4>
                ...
                <form class="form-signin mt-3" action="{{ route('updateUsersSelfProfileInfo') }}" method="POST" enctype="multipart/form-data">
                    ...
                    {{-- <div class="form-group">
                        <textarea name="location" placeholder="Your Location Link" id="" class="form-control form-control-lg" rows="1">{{ auth()->user()->location }}</textarea>
                    </div> --}}
                    <div class="form-group">
